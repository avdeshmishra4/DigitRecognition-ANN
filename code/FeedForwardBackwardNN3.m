...
NN=[256 70 50 30 17 10];            % assign number of layers and number of nodes in each layer
...
% print best beta and neural network information in a file
dlmwrite('bestBetasNN2.txt','NN=','-append');
dlmwrite('bestBetasNN2.txt',NN,'-append');
for i =1:length(NN)-1
   dlmwrite('bestBetasNN3.txt',BB{i}, '-append','roffset',2); 
end



% ----------- plot iteration versus error graph --------------------------
figure()                % to plot each plot in different window
plot (Iter,TrainErr,'.g')  % plot based on full epoch
hold
plot(Iter, TestErr, 'rx')
title('Train and Test Error versus number of iteration where green represents training error and red represents test error')
xlabel('Number of Iteration') % x-axis label
ylabel('Cumulative Sum of Squared Error') % x-axis label
legend('train error', 'test error')

figure()
plot (Iter(1:200),TrainErr(1:200))
title('Plot of Training Error Versus Number of Iteration')
xlabel('Number of Iteration') % x-axis label
ylabel('Cumulative Sum of Squared Error') % x-axis label

figure()
plot(Iter(1:200),TestErr(1:200))
title('Plot of Test Error Versus Number of Iteration')
xlabel('Number of Iteration') % x-axis label
ylabel('Cumulative Sum of Squared Error') % x-axis label
