...
NN=[256 70 50 30 10];               % assign number of layers and number of nodes in each layer
...
% print best beta and Neural Network in a file
dlmwrite('bestBetasNN2.txt',NN,'-append');
for i =1:length(NN)-1
   dlmwrite('bestBetasNN2.txt',BB{i}, '-append','roffset',2); 
end
